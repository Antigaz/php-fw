...
class Student implements User
{
    ...
    public function createEvent(string $name, string $description, string $goal, string $date, Salle $room) :Event
     {
         return new Event($name, $description, $goal, $date, $room, $this);
     }
